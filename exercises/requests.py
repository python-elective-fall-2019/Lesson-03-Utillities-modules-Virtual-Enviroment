# Create an application that asks for a url. 
# Then Download that html page, and its images, icons etc. and change it so it will work locally on your computer. Locally means that you should be able to cut you internet connection and still have a functionig html page. 
